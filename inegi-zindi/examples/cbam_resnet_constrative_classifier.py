...
from models.data import ContrastiveDataModule
from models.nn import CBAMResNet
from models.losses import CombinedLoss
from models.trainers import ContrastiveTrainer
...
def train_model():
    ...
    CONFIG_FILE = '/teamspace/studios/this_studio/inegi/inegi-zindi/examples/configs/cbam_resnet_contrastive_config.yaml'
    ...
    try:
        ...
        data_module = ContrastiveDataModule.from_config(data_module_config)
        ...
        trainer_module = ContrastiveTrainer(model, loss, optimizer_config, scheduler_config)
